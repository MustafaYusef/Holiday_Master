...
import com.mustafayusef.holidaymaster.login.profile.dashBoard.adaptersProfile.orderTicketAdapter
...
class orderTickets : Fragment(),Dashlesener {
    ...
    override fun onSucsessTicket(Response: TicketOrderRes) {
        ...
        orderTicket?.adapter=orderTicketAdapter(context!!,Response)
        animation_viewTourPub?.visibility=View.GONE
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        textViewqqq?.text="Tickets Orders"
        ...
        viewModel?.GetOrderTicket(LoginMember.cacheObj.token)
    }
