...
import com.mustafayusef.holidaymaster.Groups.groupsAdapter
...
class SpicialGroup : Fragment(),lesenerOffers {
    ...
    override fun onSucsessGroup(Response: List<group>) {
        ...
        SpicialOff_list?.adapter= groupsAdapter(context!!, Response)
    }

    companion object {
        fun newInstance() = SpicialGroup()
    }
