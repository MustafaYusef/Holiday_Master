...
class ticketDetails : Fragment(),lesenerTicketOne {
  ...
  lateinit var viewmodel:ticketDetailsViewModel
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        var ticket: Result=arguments?.getSerializable("ticket") as Result
        ...
        viewmodel?.GetDetails(LoginMember.cacheObj.token,"ow",ticket.searchParams.Adult!!,ticket.searchParams.Child!!,
        ...
        nextTicketBook?.setOnClickListener {
            ...
            view?.findNavController()?.navigate(R.id.ticketDetailsTow,bundel)
        }
