...
class FareDescription(val context: Context, val buggage: ResultRule?) : RecyclerView.Adapter<FareDescription.CustomViewHolder>(){
//
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CustomViewHolder {
        ...
        val cardItem=layoutInflater.inflate(R.layout.fare_card,parent,false)
    ...
    override fun getItemCount(): Int {
        ...
        return buggage?.Description?.size!!
    ...
    override fun onBindViewHolder(holder: CustomViewHolder, position: Int) {
        ...
        val buggage= buggage?.Description?.get(position)
        holder.view.title .text=buggage!!.Title
        holder.view.desc .text=buggage!!.Description
